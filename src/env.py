...
BOMB_FLASH_LENGTH = 10
BOMB_FLASH_INTERVAL = 2
BOMB_EXPLOSION_CLOUD_AMOUNT = 5
...
IMAGE_BOMB_FLASH_PATH = path.join(path.dirname(__file__), "../asset/image/bomb_flash.png")
IMAGE_BOMB_ICON_PATH = path.join(path.dirname(__file__), "../asset/image/bomb_icon.png")
...
IMAGE_BOMB_FLASH_URL = "https://raw.githubusercontent.com/PAIA-Playful-AI-Arena/bomb/main/asset/image/bomb_icon.png"
IMAGE_BOMB_ICON_URL = "https://raw.githubusercontent.com/PAIA-Playful-AI-Arena/bomb/main/asset/image/bomb.png"
